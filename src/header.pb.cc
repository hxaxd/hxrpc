...
static void InitDefaultsscc_info_RpcHeader_hxrpcheader_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void *ptr = &::hxrpc::_RpcHeader_default_instance_;
    new (ptr)::hxrpc::RpcHeader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::hxrpc::RpcHeader::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
    scc_info_RpcHeader_hxrpcheader_2eproto = {
        {ATOMIC_VAR_INIT(
             ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
         0, 0, InitDefaultsscc_info_RpcHeader_hxrpcheader_2eproto},
        {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_hxrpcheader_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const *
    *file_level_enum_descriptors_hxrpcheader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const *
    *file_level_service_descriptors_hxrpcheader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_hxrpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::hxrpc::RpcHeader, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        PROTOBUF_FIELD_OFFSET(::hxrpc::RpcHeader, service_name_),
        PROTOBUF_FIELD_OFFSET(::hxrpc::RpcHeader, method_name_),
        PROTOBUF_FIELD_OFFSET(::hxrpc::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, sizeof(::hxrpc::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const *const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message *>(
            &::hxrpc::_RpcHeader_default_instance_),
};

const char
    descriptor_table_protodef_hxrpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) =
        "\n\020hxrpcheader.proto\022\004hxrpc\"I\n\tRpcHeader\022\024\n"
        "\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002 "
        "\001(\014"
        "\022\021\n\targs_size\030\003 \001(\rb\006proto3";
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable *const
    descriptor_table_hxrpcheader_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase *const
    descriptor_table_hxrpcheader_2eproto_sccs[1] = {
        &scc_info_RpcHeader_hxrpcheader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
    descriptor_table_hxrpcheader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_hxrpcheader_2eproto = {
        false,
        false,
        descriptor_table_protodef_hxrpcheader_2eproto,
        "hxrpcheader.proto",
        107,
        &descriptor_table_hxrpcheader_2eproto_once,
        descriptor_table_hxrpcheader_2eproto_sccs,
        descriptor_table_hxrpcheader_2eproto_deps,
        1,
        0,
        schemas,
        file_default_instances,
        TableStruct_hxrpcheader_2eproto::offsets,
        file_level_metadata_hxrpcheader_2eproto,
        1,
        file_level_enum_descriptors_hxrpcheader_2eproto,
        file_level_service_descriptors_hxrpcheader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_hxrpcheader_2eproto =
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena *arena)
  ...
  // @@protoc_insertion_point(arena_constructor:hxrpc.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader &from)
  ...
  // @@protoc_insertion_point(copy_constructor:hxrpc.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:hxrpc.RpcHeader)
  SharedDtor();
...
void RpcHeader::Clear() {
  // @@protoc_insertion_point(message_clear_start:hxrpc.RpcHeader)
...
::PROTOBUF_NAMESPACE_ID::uint8 *RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:hxrpc.RpcHeader)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hxrpc.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
  // @@protoc_insertion_point(message_byte_size_start:hxrpc.RpcHeader)
  size_t total_size = 0;
...
void RpcHeader::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message &from) {
  // @@protoc_insertion_point(generalized_merge_from_start:hxrpc.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader *source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(&from);
  if (source == nullptr) {
    // @@protoc_insertion_point(generalized_merge_from_cast_fail:hxrpc.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
    // @@protoc_insertion_point(generalized_merge_from_cast_success:hxrpc.RpcHeader)
    MergeFrom(*source);
  }
}

void RpcHeader::MergeFrom(const RpcHeader &from) {
  // @@protoc_insertion_point(class_specific_merge_from_start:hxrpc.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
...
void RpcHeader::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message &from) {
  // @@protoc_insertion_point(generalized_copy_from_start:hxrpc.RpcHeader)
  if (&from == this)
    return;
  Clear();
  MergeFrom(from);
...
void RpcHeader::CopyFrom(const RpcHeader &from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:hxrpc.RpcHeader)
  if (&from == this)
    return;
  Clear();
  MergeFrom(from);
...
template <>
PROTOBUF_NOINLINE ::hxrpc::RpcHeader *
Arena::CreateMaybeMessage<::hxrpc::RpcHeader>(Arena *arena) {
  return Arena::CreateMessageInternal<::hxrpc::RpcHeader>(arena);
}
